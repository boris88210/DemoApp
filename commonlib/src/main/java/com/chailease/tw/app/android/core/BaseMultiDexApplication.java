 ...
 */
public class BaseMultiDexApplication extends MultiDexApplication implements IBaseApplication {

	private static BaseMultiDexApplication instance;
	...
	public static BaseMultiDexApplication getInstance(Context context) {
		if (null == instance) {
			instance = (BaseMultiDexApplication) context.getApplicationContext();
		}
		return instance;
	}
	@Override
	...
	public UserProfile getUserProfile() {
		if (null == mUsrPrfl) {
			...
			if (mUsrPrfl!=null && StringUtils.isBlank(mUsrPrfl.getUserId()))
				mUsrPrfl = null;
		}
		return mUsrPrfl;
	}
